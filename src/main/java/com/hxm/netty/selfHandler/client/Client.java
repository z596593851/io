...
import com.hxm.netty.selfHandler.common.codc.RequestEncoder;
import com.hxm.netty.selfHandler.common.codc.ResponseDecoder;
	...
	public static void main(String[] args) throws InterruptedException {
		...
		bootstrap.setPipelineFactory(new ChannelPipelineFactory() {
			...
			public ChannelPipeline getPipeline() throws Exception {
				...
				pipeline.addLast("hiHandler", new HiiHandler());
				return pipeline;
			}
		});
